...
class VGG_FeatureExtractor(nn.Module):
    ...
    def __init__(self, input_channel, output_channel=512):
        ...
        self.conv1 = nn.Conv2d(input_channel, self.output_channel[0], 3, 1, 1)
        self.relu1 = nn.ReLU(True)
        self.pool1 = nn.MaxPool2d(2, 2)  # 64x16x50

        self.conv2 = nn.Conv2d(self.output_channel[0], self.output_channel[1], 3, 1, 1)
        self.relu2 = nn.ReLU(True)
        self.pool2 = nn.MaxPool2d(2, 2) # 128x8x25

        self.conv3_1 = nn.Conv2d(self.output_channel[1], self.output_channel[2], 3, 1, 1)
        self.relu3_1 = nn.ReLU(True)  # 256x8x25
        self.conv3_2 = nn.Conv2d(self.output_channel[2], self.output_channel[2], 3, 1, 1)
        self.relu3_2 = nn.ReLU(True)
        self.pool3 = nn.MaxPool2d((2, 1), (2, 1))  # 256x4x25

        self.conv4_1 = nn.Conv2d(self.output_channel[2], self.output_channel[3], 3, 1, 1, bias=False)
        self.bn4_1 = nn.BatchNorm2d(self.output_channel[3])
        self.relu4_1 = nn.ReLU(True)  # 512x4x25
        self.conv4_2 = nn.Conv2d(self.output_channel[3], self.output_channel[3], 3, 1, 1, bias=False)
        self.bn4_2 = nn.BatchNorm2d(self.output_channel[3])
        self.relu4_2 = nn.ReLU(True)
        self.pool4 = nn.MaxPool2d((2, 1), (2, 1))  # 512x2x25

        self.conv5 = nn.Conv2d(self.output_channel[3], self.output_channel[3], 2, 1, 0)
        self.relu5 = nn.ReLU(True)  # 512x1x24
